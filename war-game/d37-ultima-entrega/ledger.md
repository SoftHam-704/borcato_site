...
| Item | Estado | Evidência | Decisão pendente |
|---|---|---|---|
| Rolagem das peças | corrigida | `f6-calibracao-palco.md`, commit `a55ccc0` | retestar em 5 larguras |
| Costuras | funcional, acabamento desigual | F4/F5 e capturas do dono | definir quais recebem nova animação |
| Preloader → Hero | funcional, ainda simples | F4 e histórico D-30 | aceitar ou refinar continuidade |
| Manchete Hero | risco visual registrado | auditoria anterior | corrigir “O”/“NOME” antes da entrega |
| Logotipos | dependência externa | logos raster atuais | receber SVGs oficiais |
